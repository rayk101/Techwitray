...
[See the example](../../examples/inventory.md)
...
Follow the [setup guide](../../docs/START_HERE.md), open the menu, then type **3** and press Enter. The sample is already included.

## Make one small change

Change a stock count in sample.csv and see the suggested order.
