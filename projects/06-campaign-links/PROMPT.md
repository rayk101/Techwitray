# Social media link builder — Claude prompt

Copy the text below into your Claude chat.

```text
I'm a beginner. Help me build a simple social media link builder.
Make labeled links for your posts.
...
Here is the existing project and its sources: https://github.com/rayk101/Techwitray/tree/main/projects/06-campaign-links
