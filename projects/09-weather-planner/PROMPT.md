# Filming weather planner — Claude prompt

Copy the text below into your Claude chat.

```text
I'm a beginner. Help me build a simple filming weather planner.
Compare days for an outdoor shoot.
...
Here is the existing project and its sources: https://github.com/rayk101/Techwitray/tree/main/projects/09-weather-planner
