# GitHub project checklist — Claude prompt

Copy the text below into your Claude chat.

```text
I'm a beginner. Help me build a simple github project checklist.
Check a project’s basic information.
...
Here is the existing project and its sources: https://github.com/rayk101/Techwitray/tree/main/projects/10-repo-check
