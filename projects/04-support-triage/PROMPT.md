# Customer message sorter — Claude prompt

Copy the text below into your Claude chat.

```text
I'm a beginner. Help me build a simple customer message sorter.
Sort sample messages into teams.
...
Here is the existing project and its sources: https://github.com/rayk101/Techwitray/tree/main/projects/04-support-triage
