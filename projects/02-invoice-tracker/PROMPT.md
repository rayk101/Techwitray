# Unpaid invoice tracker — Claude prompt

Copy the text below into your Claude chat.

```text
I'm a beginner. Help me build a simple unpaid invoice tracker.
See who still needs to pay you.
...
Here is the existing project and its sources: https://github.com/rayk101/Techwitray/tree/main/projects/02-invoice-tracker
